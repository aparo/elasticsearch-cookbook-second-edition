...
# [2013-11-22T15:32:36.736105]
curl -XGET 'http://127.0.0.1:9200/test-index/test-type/_search?from=0&pretty=true&size=10' -d '{"query": {"span_near": {"clauses": [{"span_multi": {"match": {"prefix": {"parsedtext": {"prefix": "bi"}}}}}, {"span_multi": {"match": {"prefix": {"parsedtext": {"prefix": "ni"}}}}}], "slop": 1}}}'
# response status: 200
# response body: {"took":1,"timed_out":false,"_shards":{"total":5,"successful":5,"failed":0},"hits":{"total":1,"max_score":0.5,"hits":[{"_index":"test-index","_type":"test-type","_id":"2","_score":0.5, "_source" : {"position": 2, "parsedtext": "Bill Testere nice guy", "name": "Bill Baloney", "uuid": "22222"}}]}}
# [2013-11-22T15:32:36.738500]
curl -XGET 'http://127.0.0.1:9200/test-index/test-type/_search?from=0&pretty=true&size=10' -d '{"query": {"span_near": {"clauses": [{"span_multi": {"match": {"wildcard": {"parsedtext": "bi*"}}}}, {"span_multi": {"match": {"wildcard": {"parsedtext": "ni*"}}}}], "slop": 1}}}'
# response status: 200
# response body: {"took":1,"timed_out":false,"_shards":{"total":5,"successful":5,"failed":0},"hits":{"total":1,"max_score":0.5,"hits":[{"_index":"test-index","_type":"test-type","_id":"2","_score":0.5, "_source" : {"position": 2, "parsedtext": "Bill Testere nice guy", "name": "Bill Baloney", "uuid": "22222"}}]}}
# [2013-11-22T15:32:36.741646]
curl -XGET 'http://127.0.0.1:9200/test-index/test-type/_search?from=0&pretty=true&size=10' -d '{"query": {"span_near": {"clauses": [{"span_multi": {"match": {"prefix": {"parsedtext": {"prefix": "bi"}}}}}, {"span_multi": {"match": {"wildcard": {"parsedtext": "ni*"}}}}], "slop": 1}}}'
# response status: 200
# response body: {"took":1,"timed_out":false,"_shards":{"total":5,"successful":5,"failed":0},"hits":{"total":1,"max_score":0.5,"hits":[{"_index":"test-index","_type":"test-type","_id":"2","_score":0.5, "_source" : {"position": 2, "parsedtext": "Bill Testere nice guy", "name": "Bill Baloney", "uuid": "22222"}}]}}
# [2013-11-22T15:32:36.744066]
curl -XHEAD 'http://127.0.0.1:9200/test-index?pretty=true'
# response status: 200
# response body: 
# [2013-11-22T15:32:36.744758]
