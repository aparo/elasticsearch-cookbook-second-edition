...
# [2013-11-22T15:32:22.872247]
curl -XPOST 'http://127.0.0.1:9200/test-index/_optimize?wait_for_merge=true&only_expunge_deletes=false&pretty=true&flush=true&max_num_segments=1&refresh=true'
# response status: 200
# response body: {"ok":true,"_shards":{"total":10,"successful":5,"failed":0}}
# [2013-11-22T15:32:22.908226]
curl -XHEAD 'http://127.0.0.1:9200/test-index?pretty=true'
# response status: 200
# response body: 
# [2013-11-22T15:32:22.909001]
