...
# [2013-11-22T15:32:31.773524]
curl -XGET 'http://127.0.0.1:9200/test-index/test-type/_search?from=0&pretty=true&size=10' -d '{"query": {"custom_score": {"lang": "python", "query": {"match_all": {}}, "script": "_score*(5+doc['position'].value)"}}}'
# response status: 400
# response body: {"error":"SearchPhaseExecutionException[Failed to execute phase [query], all shards failed; shardFailures {[0_XGViGhSvOT6mmHGpV3vQ][test-index][0]: SearchParseException[[test-index][0]: from[-1],size[-1]: Parse Failure [Failed to parse source [{\"query\": {\"custom_score\": {\"lang\": \"python\", \"query\": {\"match_all\": {}}, \"script\": \"_score*(5+doc['position'].value)\"}}}]]]; nested: QueryParsingException[[test-index] [custom_score] the script could not be loaded]; nested: ElasticSearchIllegalArgumentException[script_lang not supported [python]]; }{[0_XGViGhSvOT6mmHGpV3vQ][test-index][2]: SearchParseException[[test-index][2]: from[-1],size[-1]: Parse Failure [Failed to parse source [{\"query\": {\"custom_score\": {\"lang\": \"python\", \"query\": {\"match_all\": {}}, \"script\": \"_score*(5+doc['position'].value)\"}}}]]]; nested: QueryParsingException[[test-index] [custom_score] the script could not be loaded]; nested: ElasticSearchIllegalArgumentException[script_lang not supported [python]]; }{[0_XGViGhSvOT6mmHGpV3vQ][test-index][1]: SearchParseException[[test-index][1]: from[-1],size[-1]: Parse Failure [Failed to parse source [{\"query\": {\"custom_score\": {\"lang\": \"python\", \"query\": {\"match_all\": {}}, \"script\": \"_score*(5+doc['position'].value)\"}}}]]]; nested: QueryParsingException[[test-index] [custom_score] the script could not be loaded]; nested: ElasticSearchIllegalArgumentException[script_lang not supported [python]]; }{[0_XGViGhSvOT6mmHGpV3vQ][test-index][4]: SearchParseException[[test-index][4]: from[-1],size[-1]: Parse Failure [Failed to parse source [{\"query\": {\"custom_score\": {\"lang\": \"python\", \"query\": {\"match_all\": {}}, \"script\": \"_score*(5+doc['position'].value)\"}}}]]]; nested: QueryParsingException[[test-index] [custom_score] the script could not be loaded]; nested: ElasticSearchIllegalArgumentException[script_lang not supported [python]]; }{[0_XGViGhSvOT6mmHGpV3vQ][test-index][3]: SearchParseException[[test-index][3]: from[-1],size[-1]: Parse Failure [Failed to parse source [{\"query\": {\"custom_score\": {\"lang\": \"python\", \"query\": {\"match_all\": {}}, \"script\": \"_score*(5+doc['position'].value)\"}}}]]]; nested: QueryParsingException[[test-index] [custom_score] the script could not be loaded]; nested: ElasticSearchIllegalArgumentException[script_lang not supported [python]]; }]","status":400}
# [2013-11-22T15:32:31.778745]
curl -XHEAD 'http://127.0.0.1:9200/test-index?pretty=true'
# response status: 200
# response body: 
# [2013-11-22T15:32:31.779456]
