...
# [2013-11-22T15:32:35.647673]
curl -XGET 'http://127.0.0.1:9200/test-index/test-type/_search?from=0&pretty=true&size=10' -d '{"query": {"custom_score": {"lang": "mvel", "query": {"match_all": {}}, "script": "doc.position.value"}}}'
# response status: 200
# response body: {"took":1,"timed_out":false,"_shards":{"total":5,"successful":5,"failed":0},"hits":{"total":3,"max_score":3.0,"hits":[{"_index":"test-index","_type":"test-type","_id":"3","_score":3.0, "_source" : {"position": 3, "parsedtext": "Bill is not\n                nice guy", "name": "Bill Clinton", "uuid": "33333"}},{"_index":"test-index","_type":"test-type","_id":"2","_score":2.0, "_source" : {"position": 2, "parsedtext": "Bill Testere nice guy", "name": "Bill Baloney", "uuid": "22222"}},{"_index":"test-index","_type":"test-type","_id":"1","_score":1.0, "_source" : {"position": 1, "parsedtext": "Joe Testere nice guy", "name": "Joe Tester", "uuid": "11111"}}]}}
# [2013-11-22T15:32:35.650624]
curl -XGET 'http://127.0.0.1:9200/test-index/test-type/_search?from=0&pretty=true&size=10' -d '{"query": {"custom_score": {"lang": "mvel", "query": {"match_all": {}}, "script": "doc.position.value"}}, "rescore": {"query": {"rescore_query_weight": -10, "query_weight": 1, "rescore_query": {"custom_score": {"lang": "mvel", "query": {"match_all": {}}, "script": "doc.position.value"}}}, "window_size": 3}}'
# response status: 200
# response body: {"took":1,"timed_out":false,"_shards":{"total":5,"successful":5,"failed":0},"hits":{"total":3,"max_score":-9.0,"hits":[{"_index":"test-index","_type":"test-type","_id":"1","_score":-9.0, "_source" : {"position": 1, "parsedtext": "Joe Testere nice guy", "name": "Joe Tester", "uuid": "11111"}},{"_index":"test-index","_type":"test-type","_id":"2","_score":-18.0, "_source" : {"position": 2, "parsedtext": "Bill Testere nice guy", "name": "Bill Baloney", "uuid": "22222"}},{"_index":"test-index","_type":"test-type","_id":"3","_score":-27.0, "_source" : {"position": 3, "parsedtext": "Bill is not\n                nice guy", "name": "Bill Clinton", "uuid": "33333"}}]}}
# [2013-11-22T15:32:35.653252]
curl -XHEAD 'http://127.0.0.1:9200/test-index?pretty=true'
# response status: 200
# response body: 
# [2013-11-22T15:32:35.654132]
