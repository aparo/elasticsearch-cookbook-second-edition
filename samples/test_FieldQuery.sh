...
# [2013-11-22T15:32:32.585912]
curl -XGET 'http://127.0.0.1:9200/test-index/_search?from=0&pretty=true&size=10' -d '{"query": {"field": {"name": "+joe"}}}'
# response status: 200
...
# [2013-11-22T15:32:32.587896]
curl -XHEAD 'http://127.0.0.1:9200/test-index?pretty=true'
# response status: 200
# response body: 
# [2013-11-22T15:32:32.588558]
