...
# [2013-11-22T15:32:33.143613]
curl -XGET 'http://127.0.0.1:9200/test-index/_search?from=0&pretty=true&size=10' -d '{"query": {"has_child": {"query": {"term": {"name": "data1"}}, "type": "test-type2"}}}'
# response status: 200
...
# [2013-11-22T15:32:33.145899]
curl -XHEAD 'http://127.0.0.1:9200/test-index?pretty=true'
# response status: 200
# response body: 
# [2013-11-22T15:32:33.146726]
