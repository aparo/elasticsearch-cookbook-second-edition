...
# [2013-11-22T15:32:31.491658]
curl -XGET 'http://127.0.0.1:9200/test-index/test-type/_search?from=0&pretty=true&size=10' -d '{"query": {"custom_score": {"lang": "mvel", "query": {"match_all": {}}, "script": "_score*(5+doc.position.value)"}}}'
# response status: 200
# response body: {"took":1,"timed_out":false,"_shards":{"total":5,"successful":5,"failed":0},"hits":{"total":3,"max_score":8.0,"hits":[{"_index":"test-index","_type":"test-type","_id":"3","_score":8.0, "_source" : {"position": 3, "parsedtext": "Bill is not\n                nice guy", "name": "Bill Clinton", "uuid": "33333"}},{"_index":"test-index","_type":"test-type","_id":"2","_score":7.0, "_source" : {"position": 2, "parsedtext": "Bill Testere nice guy", "name": "Bill Baloney", "uuid": "22222"}},{"_index":"test-index","_type":"test-type","_id":"1","_score":6.0, "_source" : {"position": 1, "parsedtext": "Joe Testere nice guy", "name": "Joe Tester", "uuid": "11111"}}]}}
# [2013-11-22T15:32:31.494783]
curl -XGET 'http://127.0.0.1:9200/test-index/test-type/_search?from=1&pretty=true&size=1' -d '{"query": {"custom_score": {"lang": "mvel", "query": {"match_all": {}}, "script": "_score*(5+doc.position.value)"}}}'
# response status: 200
# response body: {"took":1,"timed_out":false,"_shards":{"total":5,"successful":5,"failed":0},"hits":{"total":3,"max_score":8.0,"hits":[{"_index":"test-index","_type":"test-type","_id":"2","_score":7.0, "_source" : {"position": 2, "parsedtext": "Bill Testere nice guy", "name": "Bill Baloney", "uuid": "22222"}}]}}
# [2013-11-22T15:32:31.496807]
curl -XHEAD 'http://127.0.0.1:9200/test-index?pretty=true'
# response status: 200
# response body: 
# [2013-11-22T15:32:31.497501]
