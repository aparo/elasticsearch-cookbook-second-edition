...
# [2013-11-22T15:32:32.857647]
curl -XGET 'http://127.0.0.1:9200/test-index/_search?from=0&pretty=true&size=10' -d '{"query": {"fuzzy": {"name": {"min_similarity": 0.5, "prefix_length": 0, "value": "data"}}}}'
# response status: 200
# response body: {"took":9,"timed_out":false,"_shards":{"total":5,"successful":5,"failed":0},"hits":{"total":2,"max_score":1.0,"hits":[{"_index":"test-index","_type":"test-type2","_id":"1","_score":1.0, "_source" : {"name": "data1", "value": "value1"}},{"_index":"test-index","_type":"test-type2","_id":"2","_score":1.0, "_source" : {"name": "data2", "value": "value2"}}]}}
# [2013-11-22T15:32:32.868317]
curl -XHEAD 'http://127.0.0.1:9200/test-index?pretty=true'
# response status: 200
# response body: 
# [2013-11-22T15:32:32.869255]
