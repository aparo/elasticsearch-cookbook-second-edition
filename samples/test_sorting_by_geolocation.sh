...
# [2013-11-22T15:32:43.046631]
curl -XGET 'http://127.0.0.1:9200/test-index/test-type/_search?from=0&pretty=true&size=10' -d '{"sort": [{"_geo_distance": {"location": [1, 1]}}], "query": {"match_all": {}}}'
# response status: 200
# response body: {"took":1,"timed_out":false,"_shards":{"total":5,"successful":5,"failed":0},"hits":{"total":3,"max_score":null,"hits":[{"_index":"test-index","_type":"test-type","_id":"1","_score":null, "_source" : {"foo": 1, "location": {"lat": 1, "lon": 1}},"sort":[0.0]},{"_index":"test-index","_type":"test-type","_id":"2","_score":null, "_source" : {"foo": 2, "location": {"lat": 2, "lon": 2}},"sort":[157.40156104581112]},{"_index":"test-index","_type":"test-type","_id":"3","_score":null, "_source" : {"foo": 3, "location": {"lat": 3, "lon": 3}},"sort":[314.7551553654014]}]}}
# [2013-11-22T15:32:43.048776]
curl -XHEAD 'http://127.0.0.1:9200/test-index?pretty=true'
# response status: 200
# response body: 
# [2013-11-22T15:32:43.049559]
